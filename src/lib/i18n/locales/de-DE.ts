...
export const deDE: TranslationKeys = {
  ...
  models: {
    ...
    groupDownloaded: 'Heruntergeladene Modelle',
    groupNotDownloaded: 'Bereit zum Herunterladen',
    groupVramInsufficient: 'Zu wenig VRAM · Nicht herunterladbar',
    colModel: 'Modell',
    colRecommended: 'Empfohlen',
    colIntelligence: 'Intelligenz',
